...
story_folder_var = tk.StringVar()

# Interface utilisateur
tk.Label(root, text="Fichier XML :").grid(row=0, column=0, sticky="w")
tk.Entry(root, textvariable=xml_file_var, width=50).grid(row=0, column=1)
tk.Button(root, text="Parcourir", command=select_xml_file).grid(row=0, column=2)

tk.Label(root, text="Dossier 'story' :").grid(row=1, column=0, sticky="w")
tk.Entry(root, textvariable=story_folder_var, width=50).grid(row=1, column=1)
tk.Button(root, text="Parcourir", command=select_story_folder).grid(row=1, column=2)

tk.Button(root, text="Fusionner les fichiers", command=run_script).grid(row=2, column=1, pady=10)
